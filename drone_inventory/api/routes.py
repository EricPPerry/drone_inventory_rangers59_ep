...
from drone_inventory.models import User, Drone, DroneSchema, drones_schema, db, drone_schema
...
#CREATE THE DRONE ENDPOINT, takes all info we have, and use json to create drone as we see fit
...
def update_drone(current_user_token, id):
    drone = Drone.query.get(id) #Getting a drone instance from table
